...
def test_single_level_schema_deeply_nested_list_of_dicts_to_string():
    ...
    nested_validator.validate(pre_validated_record)  # This should not raise an error
    assert isinstance(
        pre_validated_record["address"]["zip"], str
...
def test_multiple_fields_conversion():
    ...
    assert isinstance(
        pre_validated_record["address"]["city"], str
...
def test_list_of_dicts_conversion():
    ...
    # Asserting the conversions
    assert isinstance(
        pre_validated_record["variations"][0]["price"], str
    ), "The 'price' should have been converted to a string."
    assert isinstance(
        pre_validated_record["variations"][1]["price"], str
    ), "The 'price' should have been converted to a string."
    assert isinstance(
        pre_validated_record["variations"][1]["size"], str
